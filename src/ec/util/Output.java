...
//        verbosity = v;
    ...
    */
    ...
    public synchronized int addLog(File file,
        ...
        //2021.7.30 this is for running the code on raapoi, this will define the out.stat file to the corresponding algorithm folder
        //====================begin=============
        this.setFilePrefix(GPRun.jobFilePrefix);
        //====================end===============

        if (filePrefix != null && filePrefix.length() > 0)
//            file = new File(file.getParent(), filePrefix + file.getName());
            file = new File(file.getParent(), filePrefix + "job." + GPRuleEvolutionState.jobSeed + ".out.stat");
